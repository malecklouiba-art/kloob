...
export function TrustBadge({ icon: Icon, label, detail }: TrustBadgeProps) {
  return (
    <div className="group flex items-center gap-3 rounded-sm border border-white/10 bg-white/[0.03] px-4 py-3.5 transition-colors duration-200 hover:border-amber/30 hover:bg-white/[0.05]">
